...
var margin = {top: 20, right: 120, bottom: 110, left: 40},
    width = document.getElementById('lead-region-bar-chart').clientWidth - margin.left - margin.right,
    height = document.getElementById('lead-region-bar-chart').clientHeight - margin.top - margin.bottom;
